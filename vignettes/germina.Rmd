...
adjusted_pvalues <- fwe_minp(new_partial_pvalues, cbind(t(distr[1:2, ]), y_tst_distr), combine = "fisher")
...
global_distr <- apply(cbind(obs_pvalue_distr[ ,1:2], y_tst_distr), 1, fisher)
