...
combined_p_fisher <- npc(partial_pvalue, distr, combine = "fisher", alternatives = c(rep("greater",6), "less"))
combined_p_liptak <- npc(partial_pvalue, distr, combine = "liptak", alternatives = c(rep("greater",6), "less"))
combined_p_tippett <- npc(partial_pvalue, distr, combine = "tippett", alternatives = c(rep("greater",6), "less"))
